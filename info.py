...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001792962793')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001792962793')
...
PUBLIC_FILE_STORE = is_enabled((environ.get('PUBLIC_FILE_STORE', "-1001792962793")), True)
