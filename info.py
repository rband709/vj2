...
PUBLIC_FILE_STORE = environ.get('PUBLIC_FILE_STORE', '-1001792962793')
FILE_STORE_CHANNEL = environ.get('FILE_STORE_CHANNEL', '-1001792962793')
#DELETE_CHANNELS = environ.get('DELETE_CHANNELS', '-1001792962793')
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001790091614') # give your force subscribe channel id here else leave it blank
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1001792962793').split()]
...
# PUBLIC_FILE_STORE = is_enabled((environ.get('PUBLIC_FILE_STORE', "tdnnkkl")), True)
